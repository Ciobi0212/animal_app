...
import com.example.zooapp.ZooListFgDirections
import com.example.zooapp.classes.Animal

class AnimalAdapter(private val animals: List<Animal>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val layoutId = when (viewType) {
            ...
            VIEW_TYPE_NORTH_AMERICA -> R.layout.north_america_cell
            VIEW_TYPE_SOUTH_AMERICA -> R.layout.south_america_cell
            VIEW_TYPE_AUSTRALIA -> R.layout.australia_cell
            VIEW_TYPE_ANTARCTICA -> R.layout.antarctica_cell
            else -> R.layout.default_cell
        }
    ...
    inner class AnimalViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            view.setOnClickListener {
                ...
                val here = ZooListFgDirections.actionZooListFragmentToAnimalDetailFragment(
                    animal.name ?: "",
                    animal.continent ?: ""
                )
                view.findNavController().navigate(here)
            }
        }
